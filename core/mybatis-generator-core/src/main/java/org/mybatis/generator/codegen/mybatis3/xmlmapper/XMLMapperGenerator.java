...
public class XMLMapperGenerator extends AbstractXmlGenerator {
    ...
    protected XmlElement getSqlMapElement() {
        ...
        addExampleDeleteWhereClauseElement(answer);
    ...
    protected void addExampleDeleteWhereClauseElement(XmlElement parentElement) {
        if (introspectedTable.getRules().generateSQLExampleWhereClause()) {
            AbstractXmlElementGenerator elementGenerator = new ExampleDeleteWhereClauseElementGenerator(
                    false, introspectedTable);
            initializeAndExecuteGenerator(elementGenerator, parentElement);
        }
    }
