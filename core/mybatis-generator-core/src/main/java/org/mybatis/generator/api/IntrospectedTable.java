...
public abstract class IntrospectedTable {
    ...
    protected enum InternalAttribute {
        ...
        ATTR_EXAMPLE_DELETE_WHERE_CLAUSE_ID,
    ...
    protected void calculateXmlAttributes() {
        ...
        // FIXME: 增加删除Example
        setExampleDeleteWhereClauseId("Example_Delete_Where_Clause"); //$NON-NLS-1$
    ...
    public void setExampleDeleteWhereClauseId(String s) {
        internalAttributes.put(InternalAttribute.ATTR_EXAMPLE_DELETE_WHERE_CLAUSE_ID,
                s);
    }
    ...
    public String getExampleDeleteWhereClauseId() {
        return "Example_Delete_Where_Clause";
    }
