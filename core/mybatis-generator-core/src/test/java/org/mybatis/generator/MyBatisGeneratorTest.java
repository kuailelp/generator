...
public class MyBatisGeneratorTest {
	...
	public void testGenerateMyBatis3WithInvalidConfig() throws Exception {
		...
		Configuration config = cp.parseConfiguration(
				this.getClass().getClassLoader().getResourceAsStream("mybatis-generator.xml"));
	...
	public void testGenerateIbatis2WithInvalidConfig() throws Exception {
		...
		ConfigurationParser cp = new ConfigurationParser(warnings);
		Configuration config = cp.parseConfiguration(
				this.getClass().getClassLoader().getResourceAsStream("generatorConfigIbatis2_badConfig.xml"));
